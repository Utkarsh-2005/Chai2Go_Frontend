...
function capitalizeAllWords(str:string) {
  ...
  return (
    ...
    <div className="mt-auto flex justify-center"> {/* This div pushes the button to the bottom */}
      <button type="button" className="focus:outline-none text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-md text-sm px-5 py-2.5 m-3" onClick={() => setShowModal(true)}>Cancel Order</button>
    </div>
    {/* <p>{props._id}</p> */}
  </div>
  </>
